...
public class TrainsController {
    ...
    public String addTrain( HttpServletRequest req, Model model) {
    ...
    public String addTrainSchedule(Model model) {
        return "addTrainSchedule";
    }

    @PostMapping("/addTrainSchedule")
    public String addTrainScheduleDetails(HttpServletRequest req, Model model){
